...
import (
	niclasgeiger_com_v1 "github.com/niclasgeiger/crd-controller/apis/niclasgeiger.com/v1"
...
func (c *FakeFoos) Get(name string, options v1.GetOptions) (result *niclasgeiger_com_v1.Foo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(foosResource, c.ns, name), &niclasgeiger_com_v1.Foo{})
...
func (c *FakeFoos) List(opts v1.ListOptions) (result *niclasgeiger_com_v1.FooList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(foosResource, foosKind, c.ns, opts), &niclasgeiger_com_v1.FooList{})
...
func (c *FakeFoos) Create(foo *niclasgeiger_com_v1.Foo) (result *niclasgeiger_com_v1.Foo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(foosResource, c.ns, foo), &niclasgeiger_com_v1.Foo{})
...
func (c *FakeFoos) Update(foo *niclasgeiger_com_v1.Foo) (result *niclasgeiger_com_v1.Foo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(foosResource, c.ns, foo), &niclasgeiger_com_v1.Foo{})
...
func (c *FakeFoos) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(foosResource, c.ns, name), &niclasgeiger_com_v1.Foo{})
...
func (c *FakeFoos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *niclasgeiger_com_v1.Foo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(foosResource, c.ns, name, data, subresources...), &niclasgeiger_com_v1.Foo{})
